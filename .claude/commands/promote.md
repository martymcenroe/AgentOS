---
description: Promote patterns from child projects to AgentOS
...
| `--permission PATTERN` | Add permission pattern to AgentOS settings |
...
- `/promote --permission "Bash(gemini:*)"` - Add permission to AgentOS
...
1. Read harvest results from `C:\Users\mcwiz\Projects\AgentOS\harvest-results.json`
...
2. **Destination:** `C:\Users\mcwiz\Projects\AgentOS\.claude\commands\{NAME}.md`
...
2. **Destination:** `C:\Users\mcwiz\Projects\AgentOS\.claude\tools\{NAME}`
3. **Generalization Required:**
   - Replace project-specific paths with variables
   - Update comment header: "Generated by AgentOS for {{PROJECT_NAME}}"
...
2. **Destination:** `C:\Users\mcwiz\Projects\AgentOS\.claude\templates\{DIR}/`
3. **Generalization Required:**
...
1. **Target:** `C:\Users\mcwiz\Projects\AgentOS\.claude\settings.local.json`
...
- **Tool:** `agentos-harvest.py` - Discover promotion candidates
