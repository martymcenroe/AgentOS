...
- [x] Fix /onboard skill to be project-aware (2026-01-14)
- [x] Add documentation scheme to Talos and maintenance (2026-01-14)
- [x] Sync permissions to all child projects (2026-01-14)
- [x] Phase 2 documentation migration - 63 files (2026-01-13)
...
2. Add new items to "Active Work" or "Backlog"
