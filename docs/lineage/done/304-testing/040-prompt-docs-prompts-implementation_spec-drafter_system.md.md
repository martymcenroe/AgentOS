# Implementation Request: docs/prompts/implementation_spec/drafter_system.md

## Task

Write the complete contents of `docs/prompts/implementation_spec/drafter_system.md`.

Change type: Add
Description: Claude system prompt for spec generation
...
### docs/standards/0702-implementation-readiness-review.md (full)
