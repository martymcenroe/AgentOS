The files don't exist yet — I'm writing the first file. Based on the LLD's data structures (Section 2.3) and function signatures (Section 2.4), I know exactly what the package should export.
