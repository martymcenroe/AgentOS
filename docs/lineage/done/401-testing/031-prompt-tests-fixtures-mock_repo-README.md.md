# Implementation Request: tests/fixtures/mock_repo/README.md

## Task

Write the complete contents of `tests/fixtures/mock_repo/README.md`.

Change type: Add
Description: Mock README for testing
...
### tests/fixtures/mock_repo/CLAUDE.md (full)
