# Implementation Request: assemblyzero/workflows/implementation_spec/nodes/analyze_codebase.py

## Task

Write the complete contents of `assemblyzero/workflows/implementation_spec/nodes/analyze_codebase.py`.

Change type: Add
Description: N1: Extract current state from files
...
### assemblyzero/workflows/implementation_spec/nodes/load_lld.py (full)
