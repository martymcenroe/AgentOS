# Implementation Request: docs/prompts/implementation_spec/reviewer_user.md

## Task

Write the complete contents of `docs/prompts/implementation_spec/reviewer_user.md`.

Change type: Add
Description: Gemini user prompt template
...
### docs/prompts/implementation_spec/reviewer_system.md (full)
