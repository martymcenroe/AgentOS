# Implementation Request: docs/prompts/implementation_spec/drafter_user.md

## Task

Write the complete contents of `docs/prompts/implementation_spec/drafter_user.md`.

Change type: Add
Description: Claude user prompt template
...
### docs/prompts/implementation_spec/drafter_system.md (full)
