Now I have all the context needed. The `tests/unit/test_analyze_codebase.py` file already exists with a comprehensive implementation. Let me output it as the complete file:
