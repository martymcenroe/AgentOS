The existing `tests/unit/test_analyze_codebase.py` already has a complete implementation. The previous attempt failed because no code block was produced. Let me output it:
