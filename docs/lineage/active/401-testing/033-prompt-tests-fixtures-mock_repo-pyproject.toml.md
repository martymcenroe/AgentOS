# Implementation Request: tests/fixtures/mock_repo/pyproject.toml

## Task

Write the complete contents of `tests/fixtures/mock_repo/pyproject.toml`.

Change type: Add
Description: Mock pyproject.toml for testing
...
### tests/fixtures/mock_repo/README.md (full)
